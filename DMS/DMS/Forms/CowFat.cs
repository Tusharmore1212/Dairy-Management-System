...
namespace DMS
{
    public partial class CowFat : Form
    {
        public CowFat()
        {
            InitializeComponent();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            //{
            con.Open();
                string query = "insert into CowFatRate values(N'" + textBox1.Text + "',N'" + textBox3.Text + "',N'" + textBox2.Text + "')";
        ...
        {
            con.Open();
            string query = "select * from CowFatRate";
        ...
        private void CowFat_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string Que = "update CowFatRate set Rate= '" + textBox2.Text + "'where Fat ='" + textBox1.Text + "' and'" + textBox3.Text + "' ";
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string que = "delete CowFatRate where Fat = '" + textBox1.Text + "' and snf= '" + textBox3.Text + "'";
        ...
        private void Sear(object sender, EventArgs e)
        {
            try
            {
                SqlDataAdapter sda = new SqlDataAdapter("select Rate from CowFatRate where Fat = '" + textBox1.Text + "' and snf='" + textBox3.Text + "'", con);
        ...
        void getid2()
        {
            ...
            try
            {
                id2 = Convert.ToDouble(textBox2.Text);
            }
            catch (Exception ex)
            {
                b = 0;
